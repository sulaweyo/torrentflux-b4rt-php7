...
/* $Id: OinkMeEngine.php 2955 2007-04-30 15:21:07Z munk $ */
...
class SearchEngine extends SearchEngineBase
{
    ...
    {
		$this->mainCatalog["41"]	= "Audio Books (Fiction)";
		$this->mainCatalog["89"]	= "Audio Books (Non-Fiction)";
		$this->mainCatalog["44"]	= "Comedy";
		$this->mainCatalog["88"]	= "Comics";
		$this->mainCatalog["90"]	= "Components";
		$this->mainCatalog["33"]	= "eBooks (Fiction)";
		$this->mainCatalog["81"]	= "eBooks (Non-Fiction)";
		$this->mainCatalog["82"]	= "eLearning Videos";
		$this->mainCatalog["69"]	= "Mac Apps";
		$this->mainCatalog["62"]	= "Music Apps";
		$this->mainCatalog["35"]	= "Phone";
		$this->mainCatalog["83"]	= "Sheet Music";
    ...
    function OinkMe( $htmlLine )
    {
        if (strlen($htmlLine) > 0)
        {
            ...
            //{
				...
				$tmpStr = substr($tmpListArr["2"], strpos($tmpListArr["2"],"<b>")+strlen("<b>"));
				$this->torrentName = substr($tmpStr, 0, strpos($tmpStr, "</b>"));
