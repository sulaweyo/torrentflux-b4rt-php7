...
/* $Id: lang-russian.php 3111 2007-06-16 23:49:48Z b4rt $ */
...
define("_TRANSFERFILE","Торрент файл");
...
define("_NEW","Новый");
define("_TRANSFERDETAILS","Описание торрента");
define("_STOPTRANSFER","Остановить торрент");
define("_RUNTRANSFER","Старт торрента");
define("_SEEDTRANSFER","Раздать торрент");
...
define("_RETURNTOTRANSFERS","Вернуться к торрентам"); // Link at the bottom of each page
define("_DATE","Дата");
