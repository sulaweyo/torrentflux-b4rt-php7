...
/* $Id: lang-slovenian.php 3111 2007-06-16 23:49:48Z b4rt $ */
...
define("_TURNONREFRESH","Omogo�?i osveževanje strani");
define("_TURNOFFREFRESH","Onemogo�?i osveževanje strani");
define("_WARNING","POZOR");
define("_DRIVESPACEUSED","Na pogonu zmanjkuje prostora!");
define("_ADMINMESSAGE","V nabiralniku vas �?aka sporo�?ilo administratorja.");
...
define("_SENDMESSAGETO","Pošlji sporo�?ilo uporabniku");
...
define("_ESTIMATEDTIME","Predvideni �?as");
...
define("_DONE","kon�?ano");
define("_INCOMPLETE","nedokon�?ano");
define("_NEW","novo");
define("_TRANSFERDETAILS","Podatki o Transfer");
define("_STOPTRANSFER","Prekini prenos k sebi");
define("_RUNTRANSFER","Zaženi Transfer");
...
define("_HIDEOFFLINEUSERS","Skrij neprijavljene uporabnike na doma�?i strani");
...
define("_PERCENTDONE","Odstotek kon�?anega");
define("_RETURNTOTRANSFERS","Vrni se domov");
define("_DATE","Datum");
define("_WROTE","piše");
define("_SENDMESSAGETITLE","Pošlji sporo�?ilo");
define("_TO","Prejemnik");
define("_FROM","Pošiljtelj");
define("_YOURMESSAGE","Vaše sporo�?ilo");
...
define("_MESSAGE","Sporo�?ilo");
define("_MESSAGES","Sporo�?ila");
define("_RETURNTOMESSAGES","Vrni se k sporo�?ilom");
