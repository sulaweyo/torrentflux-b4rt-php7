...
// +----------------------------------------------------------------------+
// | Copyright (c) 2002-2007 Kelvin Jones, Claus van Beek, Stefan Deu�en  |
// +----------------------------------------------------------------------+
// | Authors: Kelvin Jones, Claus van Beek, Stefan Deu�en                 |
// +----------------------------------------------------------------------+
...
if (!defined('vlibTemplateClassLoaded')) {
     ...
     *
     * @since 07/03/2002
     * @author Kelvin Jones, Claus van Beek, Stefan Deu�en
     * @package vLIB
     * @access public
